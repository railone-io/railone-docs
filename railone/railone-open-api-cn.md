...
欢迎使用 Railone API 文档。本文档是针对 Railone ToB 的卡业务，目前支持3个卡种类，分别是F卡、J卡、P卡，对应的虚拟卡是F-V卡、J-V卡、P-V卡，不同卡种支持的法币或手续费不同，使用流程也略有差别。
  ...
  | 卡名 |  法币  |           区别            |
  | :--------: | :----: | :------------------------------ |
  |    F卡    |  USD、MYR   |  KYC审核48h以内，mobile格式如 +8615821702552，成功会收到邮件，调用激活接口前必须先点击邮件里的链接  |
  |    J卡     | USD、EUR | KYC审核48h以内，mobile格式如 +8615821702552，卡片上会印用户的姓名，制卡时间1-2周。激活时必须提交POA或手持卡片自拍照 |
  |   P卡   | EUR       |         KYC时间1h以内， mobile格式如 +86-15821702552，country、nationality填两位国家码 |
